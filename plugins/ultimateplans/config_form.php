...
/**
 * Defines config form for Ultimate Plans plugin
 *
...
class progressreview_ultimateplans_config_form extends moodleform {
    ...
    public function process($data) {
        ...
        $params = array('plugin' => 'ultimateplans');
        return redirect(new moodle_url('/local/progressreview/plugins/index.php', $params));
    }
